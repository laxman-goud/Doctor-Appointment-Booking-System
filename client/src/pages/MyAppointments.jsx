                ...
                {appointments.map((item, index)=>(
                    <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
                        ...
                        <div className='flex flex-col gap-2 justify-end'>
                            {!item.cancelled && item.payment && <button className='text-sm text-stone-500 text-center bg-gray-200 sm:min-w-48 py-2 border rounded hover:bg-gray-400 hover:text-white transition-all duration-300'>Paid</button>}
                            ...
                            {item.cancelled && <button className='text-sm text-red-600 text-center sm:min-w-48 py-2 border border-red-500 rounded hover:bg-red-500 hover:text-white transition-all duration-300'>Appointment cancelled</button>}
                        </div>
                    </div>
                ))}
            </div>
