...
const Login = () => {
    // Accessing global variables from context
    const { backendUrl, token, setToken } = useContext(AppContext)
    const navigate = useNavigate()

    // State for toggling between login and signup mode
    ...
    return (
        <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 rounded-xl text-zinc-800 text-sm shadow-lg'>
                {/* Title */}
